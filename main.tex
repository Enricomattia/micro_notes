...
\title{Microeconomics 1 Lecture Notes}
\author{Enrico Mattia Salonia}
\date{Latest version: \today \\
Work in Progress!}  % or a fixed date
...
\include{chapters/1_eu-intro}
\include{chapters/2_eu-representation}
\include{chapters/3_eu-money-aversion}
\include{chapters/4_eu-applications_dom}
\include{chapters/5_eu-states}
%\include{chapters/6_ge-example}
%\include{chapters/7_ge-intro}
%\include{chapters/8_ge-firstwelf}
%\include{chapters/9_ge-secondwelf}
%\include{chapters/10_ge-existuniq}
