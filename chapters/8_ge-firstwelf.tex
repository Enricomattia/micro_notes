...
\paragraph{Things to read.} This lecture is based on \citet[pp. 545-550]{mas-colellMicroeconomicTheory1995}. A version of Proposition \ref{prop:envy} can be found in \citet[p. 46]{fleurbaeyFairnessResponsibilityWelfare2008}.

\section{Exercises}

\begin{exercise}
    Elaborate on why Proposition \ref{prop:envy} relates envy-freeness to equality of opportunity. There are at least a couple of things to say. As an example, does the egalitarian Walrasian allocation rule depend on individuals' endowments?
\end{exercise}
