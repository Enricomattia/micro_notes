...
\begin{definition}\label{ax:weq}
	...
	An allocation \( x \) is a \textbf{Walrasian equilibrium} if there exist strictly positive prices \( p \in \mathbb{R}^{\ell}_{++} \) such that, for all individuals \( i \),
...
We will consider a couple of variants of \usename{axn:weq}. A \textbf{Walrasian equilibrium with transfers} is a generalisation in which we allow monetary transfers among individuals before they optimise.

\begin{definition}\label{ax:weqt}
	\labelname{axn:weqt}{Walrasian equilibrium with transfers}
	An allocation \( x \) is a \textbf{Walrasian equilibrium with transfers} if there exist strictly positive prices \( p \in \mathbb{R}^{\ell}_{++} \) and transfers \( (T_i)_{i\in I} \) satisfying
...
\begin{definition}\label{ax:weqe}
	...
	An allocation \( x \) is an \textbf{Egalitarian Walrasian equilibrium} if there exist strictly positive prices \( p \in \mathbb{R}^{\ell}_{++} \) such that
...
\begin{definition}
	An allocation rule \( R^{W} \) is \textbf{Walrasian} if for all economies \( E \) it selects allocations that are Walrasian equilibria; that is, if for all \( E \) there exist prices \( p \in \mathbb{R}^{\ell}_{++} \) such that
	\[
		R^{W}(E)
		=
		\left\{
...
\begin{definition}
	An allocation rule \( R^{WT} \) is \textbf{Walrasian with transfers} if for all economies \( E \) it selects allocations that are Walrasian equilibria with transfers; that is, if for all \( E \) there exist strictly positive prices \( p \in \mathbb{R}^{\ell}_{++} \) and transfers \( (T_i)_{i\in I} \) satisfying
...
\begin{definition}
	An allocation rule \( R^{EW} \) is \textbf{Egalitarian Walrasian} if for all economies \( E \) it selects allocations that are Egalitarian Walrasian equilibria; that is, if for all \( E \) there exist prices \( p \in \mathbb{R}^{\ell}_{++} \) such that
