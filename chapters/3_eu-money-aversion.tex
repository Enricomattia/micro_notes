...
\begin{exercise}
	Write the condition for having preferences increasing in money in terms of the binary relation \( \succsim \) over CDFs. Show that such condition implies that the Bernoulli utility \( u \) is increasing.
\end{exercise}
