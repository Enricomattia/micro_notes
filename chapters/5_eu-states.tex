...
\begin{definition}\label{def:seu}
	...
	\[
		f \succsim f^{\prime} \quad \text{if and only if} \quad \sum_{s \in S} p_s u(f_s) \geq \sum_{s \in S} p_s u(f^{\prime}_s).
	\]
\end{definition}
...
\begin{definition}\label{def:seus}
	...
	\[
		f \succsim f^{\prime} \quad \text{if and only if} \quad \sum_{s \in S} p_s u_s(f_s) \geq \sum_{s \in S} p_s u_s (f^{\prime}_s).
	\]
\end{definition}
